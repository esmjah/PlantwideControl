...
# The simplified dynamic model is simulated and treated as the process.
...
for k in range(k0, NIT+1):
    ...
    if k >= k0Control:
        Error_k = np.array([r_WG1-y_WG1, r_WG2-y_WG2, uMin[2]-u_k[2], uMin[3]-u_k[3], uMin[4]-u_k[4]])
