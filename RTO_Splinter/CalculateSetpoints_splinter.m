function [WLtot,alpha1,alpha2,alpha,P1,P2,Pin,Ptop,T1,T2,T_INL,T_top] = CalculateSetpoints_splinter( x,w1,w2,FP_INL,FT_TOP,FCP_G,FCP_L)
...
alpha1 = 100*(WG1)/(WG1+WL1);
alpha2 = 100*(WG2)/(WG2+WL2);
...
Pin = FP_INL.eval([T_INL alpha Wtot Ptop]);
