...
load 'Well_160_Olga2014_Data.mat';
...
WL_w160.save('WL_w160_Olga2014_4.bspline');

WG_w160 = BSplineBuilder(xs, WG_whds, 4).build();
WG_w160.save('WG_w160_Olga2014_4.bspline');

PWH_w160 = BSplineBuilder(xs, P_whds, 4).build();
PWH_w160.save('PWH_w160_Olga2014_4.bspline');

TWH_w160 = BSplineBuilder(xs, T_whds, 4).build();
TWH_w160.save('TWH_w160_Olga2014_4.bspline');
