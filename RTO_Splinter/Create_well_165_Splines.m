...
load 'Well_165_Olga2014_Data.mat';
...
WL_w165 = BSplineBuilder(xs, WL_whds, 4).build();
WL_w165.save('WL_w165_Olga2014_4.bspline');

WG_w165 = BSplineBuilder(xs, WG_whds, 4).build();
WG_w165.save('WG_w165_Olga2014_4.bspline');

PWH_w165 = BSplineBuilder(xs, P_whds, 4).build();
PWH_w165.save('PWH_w165_Olga2014_4.bspline');

TWH_w165 = BSplineBuilder(xs, T_whds, 4).build();
TWH_w165.save('TWH_w165_Olga2014_4.bspline');

% save('IPR_165_2D_Splines_mass.mat','WL_w165','QL_w165','WG_w165','QG_w165','PWH_w165','TWH_w165')

WL = WL_w165.eval([28.5 1.35])
T1 = TWH_w165.eval([28.5 1.35])
%%
