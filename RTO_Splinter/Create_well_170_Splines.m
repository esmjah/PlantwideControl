...
load 'Well_170_Olga2014_Data.mat';
...
WL_w170.save('WL_w170_Olga2014_4.bspline');

WG_w170 = BSplineBuilder(xs, WG_whds, 4).build();
WG_w170.save('WG_w170_Olga2014_4.bspline');

PWH_w170 = BSplineBuilder(xs, P_whds, 4).build();
PWH_w170.save('PWH_w170_Olga2014_4.bspline');

TWH_w170 = BSplineBuilder(xs, T_whds, 4).build();
TWH_w170.save('TWH_w170_Olga2014_4.bspline');
