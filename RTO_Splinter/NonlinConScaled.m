function C = NonlinConScaled( x,w1,w2,FP_INL,FT_TOP,FCP_G,FCP_L,FH_G,FH_L,FTH_TOP)
...
Pwh1 = 1e5*x(6) + Delta_Pwh1;
Pwh2 = 1e5*x(6) + Delta_Pwh2;
Ptop = 5e5 + Delta_Ptop;
...
Pm = fnval(FP_INL,{T_INL,alpha,Wtot,Ptop});
