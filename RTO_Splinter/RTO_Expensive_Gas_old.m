...
options = optimoptions('fmincon','Algorithm','interior-point','MaxIter',1e3,'TolFun',1e-20,'TolCon',1e-20,'TolX',1e-20,'MaxFunEvals',1e6,'Display','final');
