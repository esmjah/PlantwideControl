...
WL_w160   = BSpline('WL_w160_Olga2014_4.bspline');
WG_w160   = BSpline('WG_w160_Olga2014_4.bspline');
PWH_w160  = BSpline('PWH_w160_Olga2014_4.bspline');
TWH_w160  = BSpline('TWH_w160_Olga2014_4.bspline');

WL_w170   = BSpline('WL_w170_Olga2014_4.bspline');
WG_w170   = BSpline('WG_w170_Olga2014_4.bspline');
PWH_w170  = BSpline('PWH_w170_Olga2014_4.bspline');
TWH_w170  = BSpline('TWH_w170_Olga2014_4.bspline');
...
P_sep = 5.03472;
DeltaP1_manifold = 0.112;
DeltaP2_manifold = 0.112;
espsilon = 1e-6;
...
Pin = 25;
  ...
  options.lb = [1.01, 1.01, 2.0, 2.0, 0.7, 20]';   % Lower bound on the variables.
  ...
  options.ipopt.constr_viol_tol       = 1e-14;
  options.ipopt.compl_inf_tol         = 1e-14;
  options.ipopt.dual_inf_tol          = 1e-14;
