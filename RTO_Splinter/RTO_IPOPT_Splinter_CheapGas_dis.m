...
FT_TOP  = BSpline('FT_TOP_Olga2014_4.bspline');
FP_INL  = BSpline('FP_INL_Olga2014_4.bspline');
FT_INL  = BSpline('FT_INL_Olga2014_4.bspline');
FCP_G   = BSpline('FCP_G_4.bspline');
FCP_L   = BSpline('FCP_L_4.bspline');

WL_w155   = BSpline('WL_w155_Olga2014_4.bspline');
WG_w155   = BSpline('WG_w155_Olga2014_4.bspline');
PWH_w155  = BSpline('PWH_w155_Olga2014_4.bspline');
TWH_w155  = BSpline('TWH_w155_Olga2014_4.bspline');

WL_w165   = BSpline('WL_w165_Olga2014_4.bspline');
WG_w165   = BSpline('WG_w165_Olga2014_4.bspline');
PWH_w165  = BSpline('PWH_w165_Olga2014_4.bspline');
TWH_w165  = BSpline('TWH_w165_Olga2014_4.bspline');
...
P_sep = 5.03472;
DeltaP1_manifold = 0.12; %18105;
DeltaP2_manifold = 0.12; %18105;
espsilon = 1e-6;
temp_offset = 0.2;%0.426;
k = 1e5;
...
Pin = 25;
  ...
  options.ub = [1.5, 1.5, 10, 10, 1.1, 28]';  % Upper bound on the variables.
