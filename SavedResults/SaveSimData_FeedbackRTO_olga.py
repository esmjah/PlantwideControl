...
Ju_OnSOC = NP.zeros((Ns, len(controlTagsModelica)))
Ju1 = NP.zeros(Ns)
Ju2 = NP.zeros(Ns)
J_OnSOC = NP.zeros(Ns)
...
simData['J_OnSOC'] = J_OnSOC
simData['Ju_OnSOC'] = Ju_OnSOC
simData['simTime'] = sim_time
simData['R0'] = R0
simData['R'] = KF.R
simData['compTime'] = computation_time/3600

sio.savemat('SavedResults\\Nominal_FeedbackRTO_rate_limiter.mat', simData)
