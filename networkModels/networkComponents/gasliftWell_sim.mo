...
model gasliftWell_Sim
  ...
  Modelica.Blocks.Interfaces.RealInput P_res(min=150,max=180,start=160);
  Modelica.Blocks.Interfaces.RealInput alpha_Gm(min=0,max=0.1,start=0);
...
alpha_G_m_in = alpha_Gm; //0.01*(par.GOR_nom+GOR)/(1+0.01*(par.GOR_nom+GOR));
